...
export const EditTransaction = () => {
    ...
    return (
        <Container>
            <Header>
                <HeaderInfo>
                    <HeaderTitle>Atualizar transação</HeaderTitle>
                    <HeaderSubtitle>Atualize uma transação, preencha todos os campos abaixo e clique em salvar!</HeaderSubtitle>
                </HeaderInfo>
            </Header>
            ...
            {!loadingRequest && <>
                <Body>
                    <TextInput label="Título da transação" placeholder="Ex: Salário" value={titleValue} onChange={e => setTitleValue(e.target.value)} borderRadius="sm" />
                    <TextInput label="Valor" placeholder="Ex: 1.000,00 ou -1.000,00" value={amountValue} onChange={e => setAmountValue(e.target.value)} borderRadius="sm" />
                ...
                <Footer>
                    <Button onClick={handleOnClick} size='md' width='110px'>Salvar</Button>
                </Footer>
            </>}
        </Container>
    )
