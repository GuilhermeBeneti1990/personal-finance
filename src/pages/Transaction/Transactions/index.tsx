...
export const Transactions = () => {
    ...
    const handleSearch = () => {
        setTransactionsFiltered(transactions.filter(transaction => transaction.title.toLocaleLowerCase().includes(searchValue.toLocaleLowerCase())));
    }

    const handleEditTransaction = (id: number) => navigate(`/transactions/${id}/edit`);
    ...
    return (
        <Container>
            <Header>
                ...
                <HeaderSearch>
                    <HeaderSearchInput>
                        <TextInput value={searchValue} onChange={e => setSearchValue(e.target.value)} placeholder="Pesquisar por..." />
                    </HeaderSearchInput>
            ...
            {!loadingRequest &&
                <Body>
                    {transactionsFiltered.length === 0 ? <Empty>
                        <EmptyIcon />
                        <EmptyLabel>
                    ...
                    <>
                        <TransactionsTable data={transactionsFiltered} onEdit={handleEditTransaction} onDelete={handleDeleteTransactions}/>
                        <Pagination>
