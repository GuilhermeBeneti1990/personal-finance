...
export const Dashboard = () => {
    ...
    const handleMonthSelect = (e: ChangeEvent<HTMLSelectElement>) => setMonthSelected(e.target.value);
    const handleYearSelect = (e: ChangeEvent<HTMLSelectElement>) => setYearSelected(e.target.value);
    ...
    return (
        <Container>
            <Header>
                ...
                <HeaderFilter>
                    <SelectInput value={monthSelected} options={getMonths()} onChange={handleMonthSelect} />
                    <SelectInput value={yearSelected} options={getYears()} onChange={handleYearSelect} />
                </HeaderFilter>
            </Header>
            ...
            {!loadingRequest && <Body>
                ...
                <BodyRow style={{marginTop:30}}>
                    <NewTransactionCard to="transactions/new">
