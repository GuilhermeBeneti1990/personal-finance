...
export const Auth = ({ type }: Props) => {
    ...
    return (
        <Wrapper>
            <Container>
                <Alert type={showAlert.type} show={showAlert.show} setShow={show => setShowAlert({ ...showAlert, show })} title={showAlert.message} />
                <Card>
                    <CardHeader>
                        <CardTitle>
                    ...
                    <CardFooter>
                        ...
                        {type == 'signin' ? <Link to="/signup">Não tem conta? Registrar-se</Link> : <Link to="/signin">Já tem conta? Entrar</Link>}
                    </CardFooter>
                </Card>
            </Container>
        </Wrapper>
